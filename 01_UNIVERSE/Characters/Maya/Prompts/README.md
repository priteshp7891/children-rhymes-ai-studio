...
This folder contains the canonical generation prompts for Maya.
...
This is the current canonical generation specification for Maya.

## Prompt Rules

- Identify Maya explicitly.
...
1. Canonical Maya reference images
2. Locked Visual DNA
...
- Maya's yellow star hair clip must remain on her anatomical LEFT side.
- Never mirror Maya's character design or duplicate the star clip.
- Maya's purple idea/story notebook is a scene-dependent prop, not permanent character design.
