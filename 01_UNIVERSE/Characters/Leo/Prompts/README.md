...
This folder contains the canonical generation prompts for Leo.
...
This is the current canonical generation specification for Leo.

## Prompt Rules

- Identify Leo explicitly.
...
1. Canonical Leo reference images
2. Locked Visual DNA
...
- Leo's Concept 2 hairstyle is locked.
- Leo must have exactly one wristband on his LEFT WRIST only.
- Never place the wristband on the right wrist or generate two wristbands.
