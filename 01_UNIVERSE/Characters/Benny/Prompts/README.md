...
This folder contains the canonical generation prompts for Benny.
...
This is the current canonical generation specification for Benny.

## Prompt Rules

- Identify Benny explicitly.
...
1. Canonical Benny reference images
2. Locked Visual DNA
...
- Exactly one star collar tag must be present.
- Do not introduce clothing unless explicitly approved.
